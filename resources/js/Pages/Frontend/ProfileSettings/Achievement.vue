...
const resetAchievementForm = () => {
    ...
    achievementForm.graduate_achievement_date = null;
...
const openUpdateAchievementModal = (entry) => {
    ...
    achievementForm.graduate_achievement_title = entry.graduate_achievement_title;
    achievementForm.graduate_achievement_type = entry.graduate_achievement_type;
    achievementForm.graduate_achievement_issuer = entry.graduate_achievement_issuer;
    achievementForm.graduate_achievement_date = entry.graduate_achievement_date ? new Date(entry.graduate_achievement_date) : null;
    achievementForm.graduate_achievement_description = entry.graduate_achievement_description || '';
    achievementForm.graduate_achievement_url = entry.graduate_achievement_url || '';
    achievementForm.noCredentialUrl = !entry.graduate_achievement_url;
    achievementForm.credential_picture_url = entry.credential_picture_url || null;
            ...
            <div>
                ...
                <div v-if="achievementEntries.length > 0" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <div v-for="achievement in achievementEntries" :key="achievement.id"
                        ...
                        <div class="space-y-1">
                            <p class="text-sm"><span class="font-medium">Issuer:</span> {{ achievement.issuer }}</p>
                            <p class="text-sm"><span class="font-medium">Date:</span> {{ formatDate(achievement.date) }}
                            </p>
                        </div>
                        <div class="text-sm">
                            <p class="text-sm"><span class="font-medium">Description:</span> {{ achievement.description
                                }}</p>
                        </div>
                        <div class="text-sm">
                            <p class="mt-2">
                                ...
                                <span v-if="achievement.url">
                                    <a :href="achievement.url" class="text-blue-600 hover:underline" target="_blank">
                                        {{ achievement.url }}
                                    </a>
                                </span>
                        ...
                        <div class="flex justify-end space-x-2 mt-3">
                            <button @click="openUpdateAchievementModal(achievement)" class="text-gray-600 hover:text-indigo-600">
                        ...
                        <div v-for="achievement in archivedAchievementEntries" :key="achievement.id"
                            ...
                            <div class="opacity-75">
                                <div class="border-b pb-2">
                                    ...
                                    <span class="text-sm text-gray-600">{{ achievement.graduate_achievement_type
                                        }}</span>
                                </div>
                                <div class="space-y-1">
                                    ...
                                    <p class="text-sm"><span class="font-medium">Date:</span> {{
                                        formatDate(achievement.graduate_achievement_date) }}</p>
                                </div>
                                <div class="text-sm">
                                ...
                                <div class="text-sm">
                                    <p class="mt-2">
                                        URL:
                                        <span
                                            v-if="achievement.graduate_achievement_url && !achievement.noCredentialUrl">
                        ...
                        <div class="max-h-96 overflow-y-auto">
                            ...
                            <div class="mb-4">
                                <label class="block text-gray-700 font-medium mb-2">Date <span
                                        class="text-red-500">*</span></label>
                                <Datepicker name="graduate_achievement_date"
                                    v-model="achievementForm.graduate_achievement_date"
                                    class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-600"
                            ...
                            <div class="mb-4">
                                ...
                                <div class="mt-2">
                                    <input type="checkbox" id="no-credential-url"
                                        v-model="achievementForm.noCredentialUrl" class="mr-2" />
