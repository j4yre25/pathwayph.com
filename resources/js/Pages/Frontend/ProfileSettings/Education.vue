...
<template>
  <div v-if="activeSection === 'education'" class="flex flex-col">
    ...
    <div class="w-full mb-6">
      ...
      <div>
        <h2 class="text-lg font-medium mb-4">Other Active Education</h2>
    ...
    <div class="bg-white p-6 rounded-lg border border-gray-200 mb-8">
      <h2 class="text-xl font-semibold mb-2">Active Education</h2>
      <p class="text-gray-600 mb-4">Your official school record</p>
