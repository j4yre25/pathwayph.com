...
..."></textarea>
    ...
    <Modal :show="showSuccessModal" @close="showSuccessModal = false">
      <div class="p-6">
        ...
        <div class="flex justify-center">
          <button @click="showSuccessModal = false" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition">
            Close
          </button>
        </div>
      </div>
    ...
    <Modal :show="showErrorModal" @close="showErrorModal = false">
      <div class="p-6">
        ...
        <div class="flex justify-center">
          <button @click="showErrorModal = false" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition">
            Close
          </button>
        </div>
      </div>
