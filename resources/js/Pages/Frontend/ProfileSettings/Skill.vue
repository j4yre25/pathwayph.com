...
<template>
  <div v-if="activeSection === 'skills' || activeSection === 'skills-experience'" class="flex flex-col">
                    ...
                    <div v-for="skill in skillsGroup" :key="skill.graduate_skills_name"
                      ...
                      <div class="mt-3">
                        <div class="w-full bg-gray-200 rounded-full h-2.5 overflow-hidden">
                          <div class="h-2.5 rounded-full transition-all duration-300 bg-blue-500"
                            :class="{
          ...
          <div v-for="experienceEntry in experienceEntries" :key="experienceEntry.id"
            ...
            <div>
              <div class="border-b border-blue-100 pb-3">
                ...
                <p class="text-gray-600 font-medium">{{ experienceEntry.company }}</p>
              </div>
      ...
      <div v-if="showArchivedExperience" class="mt-8">
        ...
        <div v-if="archivedExperienceEntries.length > 0" class="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div v-for="experienceEntry in archivedExperienceEntries" :key="experienceEntry.id"
            ...
            <div class="absolute top-4 right-4 flex space-x-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
              <button class="text-blue-600 hover:text-blue-800 bg-blue-100 p-1.5 rounded-full" @click="unarchiveExperience(experienceEntry)">
                <i class="fas fa-box-open"></i>
              </button>
              <button class="text-red-600 hover:text-red-800 bg-red-50 p-1.5 rounded-full" @click="deleteExperience(experienceEntry.id)">
                <i class="fas fa-trash"></i>
        ...
        <div v-else class="bg-white p-8 rounded-lg shadow border border-blue-50 text-center">
          <div class="flex flex-col items-center justify-center py-4">
            ...
            <p class="text-gray-600 max-w-md mx-auto">When you archive work experience entries, they will appear here.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div v-if="isAddExperienceModalOpen" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
      <div class="bg-white p-6 rounded-lg shadow-lg w-full max-w-md border border-blue-100">
        <div class="flex justify-between items-center mb-6 border-b border-blue-100 pb-3">
          ...
          <button class="text-gray-500 hover:text-blue-700 bg-blue-50 p-2 rounded-full transition-colors duration-200" @click="closeAddExperienceModal">
            <i class="fas fa-times"></i>
          </button>
        </div>
    ...
    <div v-if="isUpdateExperienceModalOpen"
      ...
      <div class="bg-white p-6 rounded-lg shadow-lg w-full max-w-md border border-blue-100">
        <div class="flex justify-between items-center mb-6 border-b border-blue-100 pb-3">
          ...
          <button class="text-gray-500 hover:text-blue-700 bg-blue-50 p-2 rounded-full transition-colors duration-200" @click="closeUpdateExperienceModal">
            <i class="fas fa-times"></i>
          </button>
        </div>
        <div class="max-h-96 overflow-y-auto px-1">
