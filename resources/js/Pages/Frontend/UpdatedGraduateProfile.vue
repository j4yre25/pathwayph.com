    ...
    <AppLayout>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <HeaderSection 
                :graduate="graduate" 
                :full-name="fullName"
                @copy-email="copyToClipboard(graduate.email)"
            ...
            <div v-if="isCompany" class="mb-8 bg-white rounded-lg shadow-md p-6 border border-gray-200 hover:border-indigo-200 transition-all duration-300">
                ...
                <div v-if="isHiring && hiringProcess" class="mt-6 pt-6 border-t border-gray-200">
                    ...
                    <div class="relative">
                        ...
                        <div class="flex justify-between mt-4">
                            <div 
                                v-for="stage in hiringProcess.total_stages" 
                                :key="stage"
                            ...
                            >
                                <div 
                                    class="w-8 h-8 rounded-full flex items-center justify-center mb-2 transition-all duration-300 cursor-pointer transform hover:scale-110"
                                    :class="{
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-1 space-y-8">
                    ...
                    <SkillsSection 
                        :skills="skills" 
                        :grouped-skills="groupedSkillsByCategory"
