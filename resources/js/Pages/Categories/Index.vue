        ...
        <Container class="py-8">
            ...
            <div
                ...
                <div class="flex items-center space-x-4">
                    <Link :href="route('categories.list')" 
                        :class="[route().current('categories.list') ? 'bg-blue-50 text-blue-600 border-blue-200' : 'text-gray-600 hover:bg-gray-50 border-gray-200',
                    ...
                    <Link :href="route('categories.archivedlist')" 
                        :class="[route().current('categories.archivedlist') ? 'bg-blue-50 text-blue-600 border-blue-200' : 'text-gray-600 hover:bg-gray-50 border-gray-200',
                            'px-4 py-2 rounded-md flex items-center space-x-2 font-medium transition-colors border']">
                ...
                <Link :href="route('categories.create')" 
                    :class="[route().current('categories.create') ? 'bg-blue-600' : 'bg-blue-500 hover:bg-blue-600',
            ...
            <div class="bg-white rounded-lg shadow-sm overflow-hidden mb-8">
                <div class="p-4 border-b border-gray-200 flex items-center">
                    ...
                    <h3 class="font-medium text-gray-700">Filter by Category</h3>
                    <div class="ml-auto">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                       <div>
                        <label for="statusFilter" class="mr-2 text-sm font-medium text-gray-700">Category:</label>
