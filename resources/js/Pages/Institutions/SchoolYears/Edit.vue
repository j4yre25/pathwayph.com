    ...
    <template #header>
      <div>
        <div class="flex items-center">
          ...
          <h2 class="text-2xl font-bold text-gray-800">Edit School Year</h2>
        </div>
        <p class="text-sm text-gray-500 mb-1">Update the school year in the system.</p>
      </div>
    </template>
      ...
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-lg sm:rounded-2xl">
          <div class="p-6 bg-white">
            <form @submit.prevent="updateSchoolYear" class="space-y-6">
              <div>
              ...
              <div class="flex justify-end pt-4">
                ...
                >
                  ...
                  {{ form.processing ? 'Updating...' : 'Update School Year' }}
                </button>
              </div>
            </form>
          </div>
