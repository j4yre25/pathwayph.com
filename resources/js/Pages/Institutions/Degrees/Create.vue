        ...
        <template #header>
            <div>
                <div class="flex items-center">
                    ...
                    <h2 class="text-2xl font-bold text-gray-800">Add Degree</h2>
                </div>
                <p class="text-sm text-gray-500 mb-1">Register a new degree in the system.</p>
            </div>
        </template>
        <div class="py-8">
                        ...
                        <form @submit.prevent="createDegree" class="space-y-6">
                            ...
                            <div class="flex justify-end pt-4">
                                ...
                                >
                                    ...
                                    {{ form.processing ? 'Saving...' : 'Save Degree' }}
                                </button>
                            </div>
                        </form>
                    </div>
