            ...
            <div class="bg-white rounded-lg shadow-sm border border-white-200 mb-6 overflow-hidden p-6">
                 <div class="flex items-center justify-between border-b border-gray-200 overflow-x-auto mb-6">
                    ...
                    <div class="flex items-center gap-2">
                        <Link :href="route('company.jobs.edit', { job: job.id })" class="flex items-center px-8 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                            <i class="fas fa-edit mr-2"></i>
                            Edit Job
                        </Link>
                        <Link :href="route('company.jobs.manage', { user: page.props.auth.user.id })" class="flex items-center px-8 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
