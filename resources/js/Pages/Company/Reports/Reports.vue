...
const pieOption = ref({
  ...
  legend: {
    orient: "vertical",
    left: 0, // Move legend to the far left
  ...
  series: [
    {
      ...
      type: "pie",
      radius: "60%",
      center: ["60%", "50%"], // Move pie chart to the right to make space for legend
      data: [],
      emphasis: {
        itemStyle: {
          shadowBlur: 10,
    ...
    <div class="max-w-5xl mx-auto py-8 px-4">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-10 ">
        <div
          v-for="kpi in kpis"
          :key="kpi.label"
          class="bg-white rounded-lg shadow p-6 flex flex-col items-center justify-start"
        >
