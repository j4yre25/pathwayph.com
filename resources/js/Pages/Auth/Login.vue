      ...
      <div class="bg-white p-8 rounded-3xl shadow-lg border border-gray-200">
        <form @submit.prevent="submit" class="space-y-6">
          <div>
            ...
            <TextInput id="email" v-model="form.email" type="email"
              ...
              placeholder="Enter your email" required autofocus aria-autocomplete="username" />
        ...
        <div class="mt-8 text-center">
          <p class="text-base text-slate-600">
            ...
            <Link href="/register"
              class="text-blue-600 hover:text-blue-700 font-semibold transition-all duration-200 ml-2">
            Sign Up
            </Link>
          </p>
        </div>
