...
<template>
    ...
    <Head>
        ...
        <meta name="description"
            content="Join Pathway to showcase your skills, connect with employers, and advance your career. The premier platform for Filipino professionals seeking global opportunities.">
        <meta property="og:title" content="Pathway - Connecting Filipino Talent Worldwide">
        <meta property="og:description"
            content="Join Pathway to showcase your skills, connect with employers, and advance your career.">
    ...
    <div class="relative min-h-screen gradient-bg overflow-hidden">
        ...
        <div id="home" class="relative z-10">
            ...
            <!-- Modern Header -->
            <header role="banner" class="fixed top-0 left-0 right-0 z-50 transition-all duration-300" :class="{
                ...
                <div class="max-w-7xl mx-auto px-6">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center">
                            <Link href="/"
                                class="flex items-center space-x-3 focus:outline-none focus:ring-2 focus:ring-cyan-400 rounded">
                        ...
                        <nav class="hidden md:flex space-x-8" role="navigation">
                            <a href="#home" @click.prevent="scrollToSection('home')"
                                :aria-current="activeSection === 'home' ? 'page' : null" :class="[
                            ...
                            <a href="#about" @click.prevent="scrollToSection('about')"
                                :aria-current="activeSection === 'about' ? 'page' : null" :class="[
                                    'text-sm font-medium transition-all duration-200 relative focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 rounded px-3 py-2',
                                    activeSection === 'about'
                                        ? 'text-blue-600 enhanced-text after:absolute after:bottom-0 after:left-0 after:right-0 after:h-0.5 after:bg-blue-600'
                                        : 'text-blue-600/80 hover:text-blue-600 hover:enhanced-text'
                            ...
                            <a href="#features" @click.prevent="scrollToSection('features')"
                                :aria-current="activeSection === 'features' ? 'page' : null" :class="[
                                    'text-sm font-medium transition-all duration-200 relative focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 rounded px-3 py-2',
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-9 mb-9">
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div class="text-left order-2 lg:order-1">
                            <!-- Hero Title -->
                            <h1
                                class="text-gray-900 font-extrabold text-6xl md:text-8xl leading-tight mb-4 enhanced-text">
                                Pathway
                            </h1>
                            ...
                            <p class="text-gray-700 text-xl md:text-2xl max-w-3xl mb-12 font-light">
                                The premier platform connecting <span
                                    class="text-[var(--text-accent)] enhanced-text">Filipino talent</span> with <span
                                    class="text-[var(--accent-color)] enhanced-text">global opportunities</span>.
                            </p>
                        ...
                        <div class="order-1 lg:order-2 flex justify-center lg:justify-end">
                            <div class="relative max-w-full">
                                <img src="/images/pathway_new.png" alt="Pathway Platform Illustration"
        ...
        <section id="about" class="min-h-screen flex items-center py-20 bg-gray-50">
            <div class="container mx-auto px-4 sm:px-6 lg:px-8 w-full">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
                    <!-- Graduates Card -->
                    <div
                        class="group bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300 ease-in-out overflow-hidden border border-gray-100">
                        <div class="relative overflow-hidden rounded-xl mb-6">
                            <img src="/images/gradplanning.jpg"
                                alt="Graduate planning career path and future opportunities"
                    ...
                    <div
                        ...
                        <div class="flex items-center mb-6">
                            <div
                                class="bg-emerald-100 p-3 rounded-full mr-4 group-hover:bg-emerald-200 transition-colors duration-300">
                                <svg class="w-6 h-6 text-emerald-600" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd"
                                        d="M4 4a2 2 0 00-2 2v8a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2H4zm0 2h12v8H4V6z"
                                        clip-rule="evenodd"></path>
                                    <path
                                        d="M5 8a1 1 0 011-1h8a1 1 0 110 2H6a1 1 0 01-1-1zM5 11a1 1 0 011-1h8a1 1 0 110 2H6a1 1 0 01-1-1z">
                                    </path>
                                </svg>
                            </div>
                            <h3
                                class="text-2xl font-bold text-gray-900 group-hover:text-emerald-600 transition-colors duration-300">
                                Institutions</h3>
                        </div>
                        <p
                            class="text-gray-600 leading-relaxed group-hover:text-gray-700 transition-colors duration-300">
                    ...
                    <!-- Industry Card -->
                    <div
                        class="group bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transform hover:-translate-y-2 transition-all duration-300 ease-in-out overflow-hidden border border-gray-100 md:col-span-2 lg:col-span-1">
                        <div class="relative overflow-hidden rounded-xl mb-6">
                            <img src="/images/industry.jpg"
                                alt="Industry professionals collaborating in modern workplace"
                                class="w-full h-48 object-cover transition-transform duration-300 group-hover:scale-110"
                                loading="lazy" />
                            <div
                                class="absolute inset-0 bg-gradient-to-t from-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                        ...
                        <div class="flex items-center mb-6">
                            <div
                                class="bg-amber-100 p-3 rounded-full mr-4 group-hover:bg-amber-200 transition-colors duration-300">
                            ...
                            <h3
                                class="text-2xl font-bold text-gray-900 group-hover:text-amber-600 transition-colors duration-300">
                                Industry</h3>
                        </div>
                        <p
                            class="text-gray-600 leading-relaxed group-hover:text-gray-700 transition-colors duration-300">
        ...
        <!-- Login Modal -->
        <div v-if="showLoginModal" class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title"
        ...
        <!-- Register Modal -->
        <div v-if="showRegisterModal" class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title"
            role="dialog" aria-modal="true">
            <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                <!-- Background overlay -->
                <div class="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity" aria-hidden="true"
