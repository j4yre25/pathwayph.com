        ...
        <Container class="py-6 space-y-6">
            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                            ...
                            <tr v-for="user in all_users.data" :key="user.id"
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <span class="text-sm font-medium text-gray-900 capitalize">{{ user.role
                                        }}</span>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-600">{{ new Date(user.created_at).toLocaleDateString()
                                    }}
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span :class="{
                                        ...
                                        <i
                                            :class="user.is_approved ? 'fas fa-check-circle mr-1.5' : 'fas fa-times-circle mr-1.5'"></i>
                ...
                <div v-if="all_users.links && all_users.links.length > 3"
                    class="px-6 py-4 flex items-center justify-center border-t border-gray-100 bg-gradient-to-r from-gray-50 to-white">
                    <nav class="flex items-center space-x-2" aria-label="Pagination">
                        <!-- Previous Button -->
                        <button v-if="all_users.prev_page_url" @click="goTo(all_users.prev_page_url)"
                        ...
                        <template v-for="(link, index) in all_users.links" :key="index">
                            <button
                                ...
                                @click="link.url ? goTo(link.url) : null" :class="[
                        ...
                        <!-- Next Button -->
                        <button v-if="all_users.next_page_url" @click="goTo(all_users.next_page_url)"
                            class="w-8 h-8 flex items-center justify-center rounded-full bg-white border border-gray-200 text-gray-600 hover:bg-blue-50 hover:border-blue-300 transition-all duration-200 shadow-sm">
