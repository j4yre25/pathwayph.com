...
<template>
    <div class="bg-white rounded-lg shadow-md overflow-hidden transition-all duration-300 hover:shadow-lg border border-indigo-50">
        ...
        <div class="relative">
            ...
            <div class="absolute bottom-0 left-0 w-full transform translate-y-1/2 flex justify-center">
                <div class="h-24 w-24 rounded-full border-4 border-white shadow-md overflow-hidden bg-white">
                    <img 
                        v-if="graduate.profile_photo_path" 
                        :src="graduate.profile_photo_path" 
                        :alt="graduate.first_name + ' ' + graduate.last_name" 
        ...
        <div class="pt-16">
            ...
            <div class="p-4 border-b border-gray-100">
                ...
                <div class="text-sm">
                    <p v-if="aboutMe" class="text-gray-600 whitespace-pre-line line-clamp-4 hover:line-clamp-none transition-all duration-300">
                        {{ aboutMe }}
                    </p>
            ...
            <div class="border-b border-gray-100">
                <div @click="showContactInfo = !showContactInfo" class="p-4 cursor-pointer hover:bg-gray-50 transition-colors duration-200">
                    <h3 class="font-semibold text-gray-700 flex items-center justify-between">
                        ...
                        <i :class="[showContactInfo ? 'fa-chevron-up' : 'fa-chevron-down', 'fas text-gray-400']" class="transition-transform duration-300"></i>
                    </h3>
                </div>
                <div v-show="showContactInfo" class="p-4 pt-0 space-y-3 text-sm">
                    <div class="flex items-center group">
                        <i class="fas fa-phone-alt text-gray-400 w-6 group-hover:text-blue-500 transition-colors duration-300"></i>
                        <span class="text-gray-700">{{ graduate.contact_number || 'No phone number' }}</span>
                        <button 
                            v-if="graduate.contact_number"
                            class="ml-2 text-gray-400 hover:text-blue-600 transition-colors duration-300 opacity-0 group-hover:opacity-100"
                            @click="copyToClipboard(graduate.contact_number)"
                    ...
                    <div class="flex items-center group">
                        <i class="fas fa-envelope text-gray-400 w-6 group-hover:text-blue-500 transition-colors duration-300"></i>
                        <span class="text-gray-700">{{ graduate.user?.email || 'Email not available' }}</span>
                        <button 
                            v-if="graduate.user?.email"
                            class="ml-2 text-gray-400 hover:text-blue-600 transition-colors duration-300 opacity-0 group-hover:opacity-100"
                            @click="copyToClipboard(graduate.user?.email)"
                    ...
                    <div class="flex items-center group">
                        <i class="fas fa-globe text-gray-400 w-6 group-hover:text-blue-500 transition-colors duration-300"></i>
            ...
            <div v-if="employmentPreferences" class="border-b border-gray-100">
                <div @click="showEmploymentPreferences = !showEmploymentPreferences" class="p-4 cursor-pointer hover:bg-gray-50 transition-colors duration-200">
                    <h3 class="font-semibold text-gray-700 flex items-center justify-between">
                        <span class="flex items-center">
                            <i class="fas fa-briefcase mr-2 text-blue-500"></i>
                            Employment Preferences
                        </span>
                        <i :class="[showEmploymentPreferences ? 'fa-chevron-up' : 'fa-chevron-down', 'fas text-gray-400']" class="transition-transform duration-300"></i>
                    </h3>
                </div>
                <div v-show="showEmploymentPreferences" class="p-4 pt-0 grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
                    ...
                    <div class="bg-gray-50 p-3 rounded-lg">
                        ...
                        <p class="text-gray-700 font-medium">
                            ₱{{ employmentPreferences.employment_min_salary ? `${employmentPreferences.employment_min_salary} - ₱${employmentPreferences.employment_max_salary || ''}` : 'Not specified' }} {{ employmentPreferences.salary_type ? (employmentPreferences.salary_type === 'monthly' ? '/ Month' : '/ Hour') : '' }}
                        </p>
                    </div>
                    <div class="bg-gray-50 p-3 rounded-lg">
            ...
            <div v-if="careerGoals" class="border-b border-gray-100">
                <div @click="showCareerGoals = !showCareerGoals" class="p-4 cursor-pointer hover:bg-gray-50 transition-colors duration-200">
                    <h3 class="font-semibold text-gray-700 flex items-center justify-between">
                        <span class="flex items-center">
                            <i class="fas fa-bullseye mr-2 text-blue-500"></i>
                            Career Goals
                        </span>
                        <i :class="[showCareerGoals ? 'fa-chevron-up' : 'fa-chevron-down', 'fas text-gray-400']" class="transition-transform duration-300"></i>
                    </h3>
                </div>
                    ...
                    <div class="bg-gray-50 p-3 rounded-lg">
                        ...
                        <p class="text-gray-700 font-medium">
                            <span v-if="careerGoals.industries_of_interest">
                                {{ careerGoals.industries_of_interest.includes(',') ? careerGoals.industries_of_interest.split(',').join(', ') : careerGoals.industries_of_interest }}
                            </span>
            ...
            <div v-if="$page && $page.props && $page.props.auth && $page.props.auth.user && $page.props.auth.user.role === 'company'">
                <div @click="showCompanyInfo = !showCompanyInfo" class="p-4 cursor-pointer hover:bg-gray-50 transition-colors duration-200">
                    <h3 class="font-semibold text-gray-700 flex items-center justify-between">
                        <span class="flex items-center">
                            <i class="fas fa-building mr-2 text-blue-500"></i>
                            Company Information
                        </span>
                        <i :class="[showCompanyInfo ? 'fa-chevron-up' : 'fa-chevron-down', 'fas text-gray-400']" class="transition-transform duration-300"></i>
                    </h3>
                </div>
                <div v-show="showCompanyInfo" class="space-y-4 p-4 pt-0">
                    ...
                    <div class="text-sm">
                        ...
                        <button class="mt-2 text-blue-500 hover:text-blue-700 text-xs flex items-center transition-colors duration-300">
