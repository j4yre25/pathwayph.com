        ...
        <div
            ...
            <div class="pt-16">
                ...
                <div v-if="employmentPreferences" class="border-b border-gray-100">
                    ...
                    <div v-show="showEmploymentPreferences"
                        class="p-4 pt-0 grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
                        ...
                        <div class="bg-gray-50 p-3 rounded-lg">
                            ...
                            <p class="text-gray-700 font-medium">
                                ...
                                ₱${employmentPreferences.employment_max_salary || ''}` : 'Not specified' }} {{
                                    employmentPreferences.salary_type ? (employmentPreferences.salary_type === 'monthly' ?
                                        '/Month' : '/ Hour') : '' }}
                            </p>
                        </div>
                        <div class="bg-gray-50 p-3 rounded-lg">
