...
class OfferDeclinedNotification extends Notification
{
    ...
    public function toMail($notifiable)
    {
        ...
        $subject = "Applicant in {$jobTitle} declined the offer";

        return (new MailMessage)
            ->subject($subject)
            ->greeting('Hello,')
            ->line("{$applicantName} has declined the offer for \"{$jobTitle}\".")
    ...
    public function toDatabase($notifiable)
    {
        ...
        return [
            'title' => "Applicant in {$jobTitle} declined the offer",
            'subtitle' => "{$applicantName} declined the offer in {$jobTitle}. Click to view more.",
            'body' => $this->messageText ?: "{$applicantName} declined the offer.",
