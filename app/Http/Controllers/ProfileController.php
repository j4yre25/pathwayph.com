...
class ProfileController extends Controller
{
    ...
    public function index()
    {
        ...
        $archivedEducationEntries = Education::withTrashed()
        ...
        return Inertia::render('Frontend/Profile', [
            ...
            'archivedEducationEntries' => $archivedEducationEntries, // <-- ADD THIS LINE
    ...
    public function educationSettings()
    {
        ...
        $archivedEducationEntries = \App\Models\Education::withTrashed()
    ...
    {
        $education = Education::findOrFail($id);
        $education->delete(); // Soft delete
        return redirect()->back()->with('flash.banner', 'Education archived successfully.');
    }

    // Unarchive (restore) a soft-deleted Education
    public function unarchiveEducation($id)
    {
        $education = Education::withTrashed()->findOrFail($id);
        $education->restore();
        return redirect()->back()->with('flash.banner', 'Education unarchived successfully.');
    }

    // Permanently delete a soft-deleted Education
    public function deleteEducation($id)
    {
        $education = Education::withTrashed()->findOrFail($id);
        $education->forceDelete();
        return redirect()->back()->with('flash.banner', 'Education permanently removed.');
    }
    ...
    // Unarchive (restore) a soft-deleted GraduateSkill
    public function unarchiveSkill($id)
    {
        $graduateSkill = GraduateSkill::withTrashed()->findOrFail($id);
        $graduateSkill->restore();
        return redirect()->back()->with('flash.banner', 'Skill unarchived successfully.');
    }

    // Permanently delete a GraduateSkill
    public function deleteSkill($id)
    {
        $graduateSkill = GraduateSkill::withTrashed()->findOrFail($id);
        $graduateSkill->forceDelete();
        return redirect()->back()->with('flash.banner', 'Skill permanently removed.');
    }
    ...
    public function archiveSkill($id)
    {
        ...
        return redirect()->back()->with('flash.banner', 'Skill archived successfully.');
    }
    ...
    public function saveEmploymentReference(Request $request)
    {
        ...
        $employmentReference->additional_notes = $request->additional_notes;
    ...
    public function resumeSettings()
    {
        ...
        // Fetch the current resume for this graduate
    ...
    public function uploadResume(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('profile.resume.settings')->with('success', 'Resume uploaded successfully!');
        } catch (\Exception $e) {
